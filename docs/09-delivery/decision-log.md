...
- Boundary: 本決定はdesign-onlyであり、API/data schema、runtime、Worker/DO、migration、checker、fixture、provider通信、staging/production設定は別Issue/PRで扱う。OQ-005/OQ-006のP0証跡がない間はBrowser Run新規起動を有効化しない。
