...
| ADR-0002 | Accepted | Chrome拡張ではなくシステム内ブラウザを第一方式にする。市場適合性による再評価条件はADR-0030で追加 |
...
| ADR-0023 | Accepted | 都度払い・パーソナル・チーム課金とStripe Linkを採用する。商用MVPでの提供順はADR-0030で更新 |
...
| ADR-0030 | Accepted | PLG型MVPを優先し、未検証の将来要件をDeferredとして価値検証前の先行固定を抑える |
