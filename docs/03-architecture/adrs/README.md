...
| ADR-0002 | Superseded | システム内Browser Runを第一方式にする旧決定（ADR-0031でChrome拡張firstへ更新） |
...
| ADR-0023 | Accepted | 都度払い・パーソナル・チーム課金とStripe Linkを採用する。商用MVPでの提供順はADR-0030を優先 |
...
| ADR-0031 | Accepted | Chrome拡張を操作記録の第一方式にし、Browser RunをMVP必須依存から外す |
