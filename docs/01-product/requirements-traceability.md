...
| FR-007 | SCR-CAPTURE-START | capture session start API（[Browser Run操作記録基盤API](../05-api/browser-capture-foundation-api.md)、[外部原価予約API契約](../05-api/external-cost-reservation-api.md)。P0 egress検証までは`BROWSER_EGRESS_NOT_VERIFIED`） | browser_sessions, capture_sessions（後続）、[外部原価予約durable state](../04-data/external-cost-reservation-state.md) | ADR-0002, ADR-0003, [ADR-0029](../03-architecture/adrs/ADR-0029-browser-run-start-reservation-state-machine.md) | AC-020, AC-023, AC-025, AC-064, `tests/capture-foundation.test.mjs`, `tests/browser-run-egress-proof.test.mjs` | #57, #84, #86, #136, #140, EPIC-04 |
...
| FR-016 | SCR-MOBILE-PREVIEW | mobile preview session start API（[Browser Run操作記録基盤API](../05-api/browser-capture-foundation-api.md)、[外部原価予約API契約](../05-api/external-cost-reservation-api.md)。P0 egress検証までは`BROWSER_EGRESS_NOT_VERIFIED`） | browser_sessions（後続）、[外部原価予約durable state](../04-data/external-cost-reservation-state.md) | ADR-0002, [ADR-0029](../03-architecture/adrs/ADR-0029-browser-run-start-reservation-state-machine.md) | AC-024, AC-025, AC-064, `tests/capture-foundation.test.mjs`, `tests/browser-run-egress-proof.test.mjs` | #57, #84, #86, #136, #140, EPIC-04 |
...
| FR-021 | SCR-BILLING, SCR-USAGE | billing summary, export APIs, [外部原価予約API契約](../05-api/external-cost-reservation-api.md)（Browser Run startのcapture/mobile-preview共通identity・retry・status mappingを含む） | entitlements, usage_counters, [外部原価予約durable state](../04-data/external-cost-reservation-state.md) | ADR-0023, DEC-064, [ADR-0029](../03-architecture/adrs/ADR-0029-browser-run-start-reservation-state-machine.md) | AC-051, AC-053, AC-055, AC-058, AC-064, AC-065 | #108, #136, #140, EPIC-04, EPIC-05, EPIC-10 |
