...
| FR-004 | SCR-MANUAL-EDITOR | `GET/POST /api/workspaces/{id}/manuals`, manual detail/draft/publish APIs | manuals, manual_revisions, manual_steps | ADR-0004, ADR-0005 | `tests/manual-api.test.mjs`, `tests/manual-edit-api.test.mjs`, `tests/e2e/phase2-manual-editor.spec.mjs`。AC-010の公開版revision作成まで。未ログイン公開URLは後続 | #63, #64, #65, #74, #80, EPIC-06 |
