...
| FR-007 | SCR-CAPTURE-START | capture-session createは新規Browser Run startのみP0 egress検証までは`BROWSER_EGRESS_NOT_VERIFIED`。既存reservation state retrievalはterminal=`200`、in-flight／`result_unknown`=`202`、fingerprint mismatch=`409`とし、live-url／commandsはcapture-startのreservation lookupを行わない | browser_sessions, capture_sessions（後続） | ADR-0002, ADR-0003 | AC-020, AC-023, AC-025, `tests/capture-foundation.test.mjs`, `tests/browser-run-egress-proof.test.mjs` | #57, #84, #86, #131, EPIC-04 |
...
| FR-021 | SCR-BILLING, SCR-USAGE | billing summary, export APIs, [外部原価予約API契約](../05-api/external-cost-reservation-api.md) | entitlements, usage_counters, [外部原価予約durable state](../04-data/external-cost-reservation-state.md) | ADR-0023, DEC-064 | AC-051, AC-053, AC-055, AC-058, AC-064, AC-065 | #108, EPIC-04, EPIC-05, EPIC-10 |
