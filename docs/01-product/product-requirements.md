...
| FR-020 | AI拡張口を持つ | 初期OFFで、外部AI APIを呼ばない。収益安定前は実装しない |
...
5. export・再生・分析・コメント（FR-014 / FR-015 / FR-017 / FR-018）
6. 課金・利用上限（FR-019 / FR-021）
...
- FR-020を有効化する変更は、収益安定後にユーザーが明示承認するまで行わない。
