...
const contractMutations = [
  ...
  ["900px再配置", "主要レイアウト", { css: APP_CSS.replaceAll("@media (max-width: 900px)", "@media (min-width: 9999px)") }],
  ...
  ["共通シェルのスキップ先", "共通シェル", { js: APP_JS.replaceAll('id="screen-content" class="main"', 'id="removed-content" class="main"') }],
  ["主要ナビの名前", "主要ナビゲーション", { js: APP_JS.replaceAll('aria-label="主要メニュー"', "") }],
  ["メンバー導線", "メンバー管理", { js: APP_JS.replaceAll('id="members-nav-button" class="nav-item nav-button" type="button">メンバー管理</button>', "メンバー管理") }],
